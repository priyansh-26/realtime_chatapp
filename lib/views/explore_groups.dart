...
class _ExploreGroupsState extends State<ExploreGroups> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Public Groups")),
      body: FutureBuilder(
                    ...
                    leading: CircleAvatar(
                      backgroundImage: snapshot.data![index].data["image"] ==
                          ...
                          : CachedNetworkImageProvider(
                              "https://cloud.appwrite.io/v1/storage/buckets/66e5c8d500029fa844fb/files/${snapshot.data![index].data["image"]}/view?project=66df2f70000a3570467e&project=66df2f70000a3570467e&mode=admin"),
                    ),
                    ...
                    trailing: ElevatedButton(
                      ...
                      onPressed: () async {
                        await addUserToGroup(
                                ...
                                currentUser: Provider.of<UserDataProvider>(
                                        context,
                                        listen: false)
                                    .getUserId)
                            .then((value) {
