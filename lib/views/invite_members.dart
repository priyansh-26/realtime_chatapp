                    ...
                    return ListTile(
                      ...
                      leading: CircleAvatar(
                        backgroundImage: user.data["profile_pic"] != null &&
                            ...
                            ? NetworkImage(
                                "https://cloud.appwrite.io/v1/storage/buckets/66e5c8d500029fa844fb/files/${user.data["profile_pic"]}/view?project=66df2f70000a3570467e&project=66df2f70000a3570467e&mode=admin")
...
class AlterInvite extends StatefulWidget {
  ...
  const AlterInvite(
      {super.key, required this.selectedUserIds, required this.groupData});
...
class _AlterInviteState extends State<AlterInvite> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      content:
          Text("Once the user accept the invite they will join the group."),
      actions: [
        TextButton(
            onPressed: () {
